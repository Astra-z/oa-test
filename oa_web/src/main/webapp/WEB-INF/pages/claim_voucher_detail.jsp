        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        <div class="col-md-2">提交人:</div>
                        <div class="col-md-2">提交时间:</div>
                        <div class="col-md-2">提交方式:</div>
                        <div class="col-md-2">处理结果:</div>
                        <div class="col-md-2"></div>
                        <br><br>
                    <c:forEach items="${records}" var="record">
                        <div class="col-md-2">${record.dealer.name}</div>
                        <div class="col-md-2"><spring:eval expression="record.dealTime"/></div>
                        <div class="col-md-2">${record.dealWay}</div>
                        <div class="col-md-2">${record.dealResult}</div>
                        <div class="col-md-2">备注：${record.comment}</div>
                        <br>
                    </c:forEach>
                    </div>
